...
public class AuthorizationFilter implements Filter {
    ...
    private static final Set<String> USER_PATH = Set.of(IMAGES, ROOM_INFO, ORDER, ORDER_DONE, MAIN_PAGE, SEE_INFO_ABOUT_ORDER, FIND_ALL_ROOMS, USER_ORDER_LIST);
    private static final Set<String> ADMIN_PATH = Set.of(IMAGES, ROOM_INFO, ADD_ROOM, ADMIN_PAGE, MAIN_PAGE, SEE_INFO_ABOUT_ORDER, FIND_ALL_ROOMS, USER_ORDER_LIST);
